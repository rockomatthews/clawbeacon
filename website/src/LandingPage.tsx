/**
 * @fileoverview Landing Page for Claw Beacon
 * 
 * Original Claw Beacon content with OpenClaw.ai visual theme:
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            >
              ...
              <a
                href="https://github.com/adarshmishra07/claw-beacon"
                target="_blank"
          ...
          >
            ...
            >
              {onEnterDashboard ? (
                ...
                <a
                  href="https://railway.com/deploy/claw-beacon?referralCode=VsZvQs&utm_medium=integration&utm_source=template&utm_campaign=generic"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-primary group px-8 py-4 rounded-xl font-semibold flex items-center gap-2"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <StepCard
              ...
              description="Fork and clone Claw Beacon from GitHub. It's open source and ready to customize."
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <CodeBlock
                code={`git clone https://github.com/adarshmishra07/claw-beacon
cd claw-beacon
docker compose up`}
                language="bash"
              />
...
npm install && npm run dev`}
            ...
            >
              ...
              <p className="text-gray-400 text-sm mb-6 break-words">
                Use the Claw Beacon skill on ClawHub to have your AI agent handle the entire deployment automatically.
              </p>
              <a
                href="https://clawhub.openclaw.ai/skills/claw-beacon"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold gradient-text">Claw Beacon</span>
            </div>
