# Contributing to Claw Beacon

First off, thanks for taking the time to contribute! 🦞

This document provides guidelines for contributing to Claw Beacon. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
2. **Clone your fork**
   ```bash
   git clone https://github.com/YOUR-USERNAME/claw-beacon.git
   cd claw-beacon
   ```
...
Feel free to:
- Open a [GitHub Discussion](https://github.com/adarshmishra07/claw-beacon/discussions)
