#!/usr/bin/env node
/**
 * @fileoverview MCP (Model Context Protocol) Server for Claw Beacon.
 * 
 * Exposes Claw Beacon's task and agent management via MCP tools,
...
async function main() {
  ...
  console.error('Claw Beacon MCP server running on stdio');
}
