...
Deploy Claw Beacon to Railway in under 5 minutes with zero configuration.
...
Click the button above to deploy your own instance of Claw Beacon!
...
3. **Open Dashboard:**
   ...
   - You should see the Claw Beacon dashboard
...
- 🐛 [Report Issues](https://github.com/adarshmishra07/claw-beacon/issues)
- 💬 [Railway Discord](https://discord.gg/railway)
- 🦞 [Claw Beacon GitHub](https://github.com/adarshmishra07/claw-beacon)
